...
|-------|----------|--------------|
| Contract | `apps/api/tests/contract/` | 40+ endpoint smoke tests |
| Integration | `apps/api/tests/integration/` | 15 feature flows |
| E2E UI | `apps/ui/e2e/` | 12 critical journeys |
