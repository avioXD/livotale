...
class DoctorAppointmentsService extends BaseApiService {
  ...
  async getAvailability(): Promise<DoctorAvailabilityResponse> {
    return this.get<DoctorAvailabilityResponse>('/doctor/availability')
  }

  async saveAvailability(payload: DoctorAvailabilityPayload): Promise<DoctorAvailabilityResponse> {
    return this.put<DoctorAvailabilityResponse>('/doctor/availability', payload)
  }
