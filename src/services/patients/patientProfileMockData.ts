...
/** Seed mock patient — Rohan Mehta (see livotale_app/api/scripts/mock-ids.js) */
...
export function getMockPatientReports(_patientId: string): ReportListItem[] {
  return [
    ...
    {
      reportKey: 'mock-lab-2026-03',
      reportCode: 'LAB-2026-0310',
      reportKind: 'lab_panel',
      title: 'Comprehensive Liver Panel',
      reportDate: daysAgo(10).slice(0, 10),
      createdAt: daysAgo(10),
      verified: true,
      fileName: 'liver-panel.pdf',
      metricCount: 12,
      overallCriticality: 'high',
      summary: 'ALT 68 U/L (elevated), AST 52 U/L, GGT 89 U/L. HbA1c 6.4%.',
    },
    {
      reportKey: 'mock-assessment-2026-02',
      reportCode: 'ASMT-2026-0215',
      reportKind: 'clinical_assessment',
      title: 'MASLD Risk Assessment',
      reportDate: daysAgo(30).slice(0, 10),
      createdAt: daysAgo(30),
      verified: true,
      fileName: 'masld-assessment.pdf',
      metricCount: 8,
      overallCriticality: 'moderate',
      summary: 'Moderate MASLD risk. Lifestyle intervention and 3-month follow-up recommended.',
    },
  ];
}
