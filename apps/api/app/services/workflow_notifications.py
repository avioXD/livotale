...
class WorkflowNotificationService:
    ...
    TRIGGER_CHANNELS: dict[str, list[str]] = {
        ...
        "patient_intake_verified": ["in_app"],
        "scan_started": ["in_app"],
    ...
    ROLE_TARGETS: dict[str, list[str]] = {
        ...
        "enquiry_converted": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        ...
        "patient_intake_verified": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "scan_completed": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "scan_started": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "sample_dispatch_pending": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "sample_dispatched": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "sample_received_at_lab": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "awaiting_lab_report": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "lab_report_uploaded": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "ai_extraction_ready": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "ai_reupload_required": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "ai_verified": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "final_report_generated": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "consultation_completed": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
        "prescription_published": ["OPERATIONS", "CITY_MANAGER", "SUPER_ADMIN"],
