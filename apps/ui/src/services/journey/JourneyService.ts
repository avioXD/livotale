...
class JourneyService extends BaseApiService {
  ...
  async getDashboardAnalytics(): Promise<PatientDashboardData> {
    return this.get<PatientDashboardData>('/patient-portal/dashboard/analytics')
  }
  ...
  async getPrescription(id: string) {
    return this.get<PendingPrescription & { diet_plan: string; exercise_plan: string; monitoring_plan: string; items: unknown[] }>(
