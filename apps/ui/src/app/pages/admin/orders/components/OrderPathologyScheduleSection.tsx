  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-base">Pathology schedule</CardTitle>
        <CardDescription>
          Select the pathology visit date and {APPOINTMENT_SLOT_DURATION_MINUTES}-minute slot, confirm the
          schedule, then create the lab order on the partner&apos;s website and save their portal order ID.
          Track collector visit and collection below by checking the lab partner portal.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {order.pathologyScheduledAt ? (
          ...
          <div className="rounded-md border border-amber-200 bg-amber-50/60 px-3 py-2 text-sm text-amber-900">
            ...
            <p className="mt-1">{formatPathologyScheduleSummary(order)}</p>
            <p className="mt-1 text-xs">Confirm the visit date and slot below.</p>
          </div>
        ) : (
        ...
        {order.pathologyScheduledAt && order.partnerLabId && (
            ...
            {!order.pathologyLabOrderRef ? (
              <div>
                ...
                <Button
                  ...
                  onClick={() => void handleCreateLabOrder()}
                >
            ...
            {order.pathologyLabOrderRef && (
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  behalf of the patient, paste the booking or order ID shown in their portal.
                </p>
                <div className="flex flex-wrap gap-2">
                  <Input
                    ...
                    disabled={
                      readOnly || Boolean(order.pathologyScheduledAt && order.pathologyVisitOutcome === 'visited')
                    }
                  />
                  {canEdit && (
                    <Button
